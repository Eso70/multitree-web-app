  ...
  return (
    <PublicSection id="features">
        <MarketingSectionHeading
          ...
          description="ئامرازەکانی Sponsor.krd بۆ بڵاوکردنەوە، پێوانەکردن و گەشەپێدانی ناسنامەی دیجیتاڵیت دروستکراون"
        />
          ...
          {MARKETING_FEATURES.slice(0, compact ? 3 : undefined).map(
            (feature) => {
              ...
              return (
                ...
                >
                  <span className="grid h-11 w-11 place-items-center rounded-2xl bg-[var(--sponsor-krd-accent)]/16 text-black dark:text-white">
