...
const BusinessClientAccessDemoPage = dynamic(
  () =>
    import("@/features/client-linktree-access/components/BusinessClientAccessDemoPage"),
  {
    ssr: false,
    loading: () => <SkeletonManagementPage />,
  },
);
